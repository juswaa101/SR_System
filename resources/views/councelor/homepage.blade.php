                    ...
                    <div class="card">
                        <div class="card-header bg-primary">
                          <div class="row">
                            ...
                            <div class="col-8">
                              <p class="display-5 fw-bold text-light text-center">Student List & Survey <i class="fa fa-edit" style="font-size:40px"></i></p>
                            </div>
                            <div class="col-2">
                                    ...
                                    @foreach($studentlist as $item)
                                        <tr>
                                            ...
                                            <td>{{$item -> section}}</td>
                                              ...
                                              <?php }?>
                                            <td>                                                
                                                <a class="btn btn-info" href="/viewsurvey/{{$item -> lrn}}" role="button"><i class="fa fa-edit" style="font-size:25x;"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                <tfoot>
              ...
              <div class="conatainer-fluid" style ="height:60vh">
                  ...
                  @if(Session::get('survey'))
                    ...
                    <div class="form-group mt-2  rounded survey">
                      ...
                      <input type="text" disabled class="form-control" placeholder="Answer" name = "s1" value="{{$item -> answer}}">
                    </div> 
                    @endforeach
                  @endif
