...
<body>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav ms-auto ">
            <li class="nav-item">
            <a class="nav-link mx-2  text-light" href="/coucelorhomepage">Home</a>
            </li>
            <li class="nav-item">
            <a class="nav-link mx-2  active" href="/surveylist">Survey </a>
            </li>
            <li class="nav-item">
                ...
                <div class="col-md-10">
                    <div class="card">
                        <div class="card-header bg-primary">
                          <div class="row">
                            <div class="col-2">
                                <button type="button" class="btn btn-warning addItemBtn fs-5 mt-3 fw-bold" data-bs-toggle="modal" data-bs-target="#exampleModal2">
                                    ADD Survey <i class="fa fa-plus" style="font-size:20px;"></i>
                                </button>
                            </div>
                            <div class="col-8">
                                <p class="display-5 fw-bold text-light text-center">Survey List <i class="fa fa-edit" style="font-size:40px"></i></p>
                            </div>
                            <div class="col-2">
                                ...
                                <tbody>
                                    @foreach($take_survey as $item)
                                        <tr>
                                            ...
                                            <td>                                                
                                                <a class="btn btn-info" href="/editsurvey/{{$item -> id}}/{{$item -> survey_question}}" role="button"><i class="fa fa-edit" style="font-size:25x;"></i></a>
                                                <a class="btn btn-danger" href="/deletesurvey/{{$item -> id}}" role="button"><i class="fa fa-trash" style="font-size:25x;"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                <tfoot>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="Survey_Question" value="{{Session::get('survey')}}" class="form-control" required>
