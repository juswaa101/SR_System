                        ...
                        <div class="card ">
                            ...
                            <div class="p-4" id="">
                                <form action="/register" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="custom-form-group ">
                                                ...
                                                <input type="text" id="Fullname" Placeholder="Last Name"
                                                    ...
                                                    class="form-contol" /><span class="pb-1"><i
                                        ...
                                        <div class="col-md-4">
                                            <div class="custom-form-group">
                                                ...
                                                <input type="text" id="Fullname" Placeholder="Given Name"
                                        ...
                                        <div class="col-md-4">
                                            <div class="custom-form-group">
                                                ...
                                                <input type="text" id="Fullname" name="mname"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="custom-form-group mt-2">
                                                ...
                                                <input type="text" id="lrn" Placeholder="LRN" name="lrn"
                                                    value="{{ old('lrn') }}" class="form-contol" /><span
                                                    class="pb-1"><i class="fas fa-user"></i></span>
                                                @error('lrn')
                                                    <p class="text-danger">
                                                        {{ $message }}
                                                    </p>
                                    ...
                                    <div class="custom-form-group mt-2">
                                        <label class="text-uppercase" for="password">Guardian Email</label>
                                        <input type="email" id="email" Placeholder="eg. juan@example.com" name="email_guardian"
                                            class="form-contol" /><span class="pb-1"><i id="showCursor"
                                                class="fas fa-eye-slash"></i></span>
                                        @error('email_guardian')
                                            <p class="text-danger">
                                                {{ $message }}
                                            </p>
                                        @enderror
                                    ...
                                    <div class="custom-form-group mt-2">
                                        ...
                                        <input type="password" id="password" Placeholder="Password" name="password"
                                            class="form-contol" /><span class="pb-1"><i id="showCursor"
                                                class="fas fa-eye-slash" onclick="showPassword(event)"></i></span>
                                        @error('password')
                                            <p class="text-danger">
                                                {{ $message }}
                                            </p>
                                    ...
                                    <p class="mt-2 text-center">Already Have an Account? <a href="/">Sign-in</a>
                                    </p>
                                    <div class="mt-5">
                                        <button class="w-100 p-2 d-block btn-danger custom-btn text-dark fw-bold">Sign
                                            Up</button>
                                    </div>
                                    <br>
                                </form>
