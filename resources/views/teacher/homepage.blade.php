        ...
        <div class="container">
            ...
            <div class=" collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link mx-2 active" aria-current="/surveylist" href="/surveylist">Survey List</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="col-mb-3 text-end">
                                    <p class="display-5 fw-bold text-light text-center">List Of Exam<i
                                ...
                                @foreach ($examList as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($item->examcode == 1) {
                                                echo 'STEM';
                                            } elseif ($item->examcode == 2) {
                                                echo 'ABM';
                                            } elseif ($item->examcode == 3) {
                                                echo 'HUMSS';
                                            } else {
                                                echo 'COOKERY   ';
                                            }
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mt-2 rounded text-center"
                                    style="background-color:rgba(114, 114, 114, .8);">
                                    <label for="" class="text-light  text-center ">Exam Category</label>
                                    <select class="form-select text-center" name="examcode"
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="form-group rounded text-center"
                                    ...
                                    <input type="text" class="form-control text-center" placeholder="ENTER ANSWER"
                                        name="Answer">
                                </div>
                                @error('Answer')
                                    <p class="text-danger">{{ $message }}</p>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mt-4 rounded "
                                    ...
                                    <input type="text" class="form-control" placeholder="ENTER CHOICE A"
                                        name="choice_A">
                                    @error('choice_A')
                                        <p class="text-danger">{{ $message }}</p>
                                        <script>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mt-4 rounded "
                                    ...
                                    <input type="text" class="form-control" placeholder="ENTER CHOICE B"
                                        name="choice_B">
                                    @error('choice_B')
                                        <p class="text-danger">{{ $message }}</p>
                                        <script>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mt-3 rounded "
                                    ...
                                    <input type="text" class="form-control" placeholder="ENTER CHOICE C"
                                        name="choice_C">
                                    @error('choice_C')
                                        <p class="text-danger">{{ $message }}</p>
                                        <script>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mt-3 rounded "
                                    ...
                                    <input type="text" class="form-control" placeholder="ENTER CHOICE D"
                                        name="choice_D">
                                    @error('choice_D')
                                        <p class="text-danger">{{ $message }}</p>
                                        <script>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="background-image: url('assets/images/mainbg.png');">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mt-2 text-light text-center rounded mt-1"
                                    style="background-color:rgba(114, 114, 114, .8);">
                            ...
                            <div class="col-md-6 mt-1">
                                <div class="form-group text-light text-center rounded mt-1"
                                    style="background-color:rgba(114, 114, 114, .8);">
                                    <label for="">Answer</label>
                                    <input type="text" class="form-control text-center" placeholder="ENTER ANSWER"
                                        name="Answer" value="{{ Session::get('answer') }}">
                                </div>
                                @error('Answer')
                                    <p class="text-danger">{{ $message }}</p>
                                    <script>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="form-group text-light text-center rounded mt-1"
                                    ...
                                    <input type="text" class="form-control text-center"
                                        placeholder="ENTER CHOICE A" name="choice_A"
                                        value="{{ Session::get('a') }}">
                                    @error('choice_A')
                                        <p class="text-danger">{{ $message }}</p>
                                        <script>
                            ...
                            <div class="col-md-6">
                                <div class="form-group text-light text-center rounded mt-1"
                                    ...
                                    <input type="text" class="form-control text-center"
                                        placeholder="ENTER CHOICE B" name="choice_B"
                                        value="{{ Session::get('b') }}">
                                    @error('choice_B')
                                        <p class="text-danger">{{ $message }}</p>
                                        <script>
...
@enderror
                ...
                <div class="col-md-6">
                    <div class="form-group  text-light text-center rounded mt-1" style =" background-color:rgba(114,
                                    114, 114, .8);"">
                                    <label for="">Choice D</label>
                                    <input type="text" class="form-control text-center"
                                        placeholder="ENTER CHOICE D" name="choice_D"
                                        value="{{ Session::get('d') }}">
                                    @error('choice_D')
                                        <p class="text-danger">{{ $message }}</p>
                                        <script>
