...
<body>
    ...
    <div class="container">
        ...
        <ul class="navbar-nav ms-auto ">
            <li class="nav-item">
            <a class="nav-link mx-2 text-light" aria-current="/teacherhomepage" href="/teacherhomepage">Home</a>
            </li>
            <li class="nav-item">
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                                <div class="col-2">
                                    ...
                                    <button type="button" class="btn btn-warning addItemBtn fs-5 mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                      ADD STUDENT <i class="fa fa-plus" style="font-size:20px;"></i>
                                  </button>
                                </div>
                                <div class="col-8">
                                    <div class="col-mb-3 text-end">
                                        <p class="display-5 fw-bold text-light text-center">Student list <i class="fa fa-edit" style="font-size:40px"></i></p> 
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="col-mb-3 text-end mt-3">
                                      <button class="btn btn-warning " id="download" style="border-radius: 5px;"><i class="fa fa-download" aria-hidden="true"></i> PDF</button>                                    </div>
                                </div>
                            </div>
                          </div>
                        <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="" method="get">
                                                    ...
                                                    <a class="btn btn-info" href="/edituser/{{$item -> id}}" role="button"><i class="fa fa-edit" style="font-size:25x;"></i></a>
    ...
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-body"  style = "background-image: url('assets/images/mainbg.png');">
            <div class="form-group text-center rounded" style ="background-color:rgba(114, 114, 114, 1);">
              ...
              <input type="text" name="Fullname" class="form-control text-center fw-bold" value="{{old('Fullname')}}">
              @error('Fullname')
              <p class="text-danger">
                {{$message}}
              </p>
            ...
            <div class="form-group text-center rounded mt-2" style ="background-color:rgba(114, 114, 114, 1);">
              <label for="" class="mt-1 h5 text-light">Last Name</label>
              <input type="text" name="lname" class="form-control text-center fw-bold" value="{{old('lname')}}">
              @error('lname')
              <p class="text-danger">
                {{$message}}
              </p>
            ...
            <div class="form-group text-center rounded mt-2" style ="background-color:rgba(114, 114, 114, 1);">
              ...
              <input type="text" name="mname" class="form-control text-center fw-bold" value="{{old('mname')}}">
              @error('mname')
              <p class="text-danger">
                {{$message}}
              </p>
            ...
            <div class="form-group mt-2 rounded text-center" style ="background-color:rgba(114, 114, 114, 1);">
              ...
              <input type="text" name="lrn" class="form-control text-center" value="{{old('lrn')}}">
              @error('lrn')
              <p class="text-danger">
                {{$message}}
              </p>
          ...
          <div class="row">
            <div class="col-text-center">
              <p class="h3 text-center text-warning">
                RECOMMENDED STRAND: <span class="bg-warning text-dark" style="padding:0 20px;border-radius:25px;">{{Session::get('recomended')}} </span>
              </p>
            </div>
          </div>
          <div class="row mt-2">
            <div class="col-md-5 ">
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group rounded text-center" style ="background-color:rgba(114, 114, 114, 1);">
                    ...
                    <input type="text" name="Fullname" class="form-control text-center fw-bold" value="{{old('Fullname')}}{{Session::get('fullname')}}">
                    @error('Fullname')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                ...
                <div class="col-md-4">
                  <div class="form-group rounded text-center" style ="background-color:rgba(114, 114, 114, 1);">
                    ...
                    <input type="text" name="lname" class="form-control text-center fw-bold" value="{{old('Fullname')}}{{Session::get('lname')}}">
                    @error('lname')
                    <p class="text-danger">
                      {{$message}}
                    </p>
                ...
                <div class="col-md-4">
                  <div class="form-group rounded text-center" style ="background-color:rgba(114, 114, 114, 1);">
                    ...
                    <input type="text" name="mname" class="form-control text-center fw-bold" value="{{old('Fullname')}}{{Session::get('mname')}}">
                    @error('mname')
                    <p class="text-danger">
                      {{$message}}
                    </p>
              ...
              <div class="form-group mt-2 rounded text-center " style ="background-color:rgba(114, 114, 114, 1);">
                ...
                <input type="text" name="lrn" class="form-control text-center fw-bold" value="{{old('lrn')}}{{Session::get('lrn')}}">
                @error('lrn')
                <p class="text-danger">
                  {{$message}}
                </p>
              ...
              <div class="form-group mt-2 text-center rounded" style ="background-color:rgba(114, 114, 114, 1);">
                <label for="" class="text-light h5 mt-1">MATH GRADE: </label>
                <input type="number" name="math" class="form-control text-center fw-bold" value="{{old('lrn')}}{{Session::get('math')}}">
                @error('lrn')
                <p class="text-danger">
                  {{$message}}
                </p>
              ...
              <div class="form-group mt-2 text-center rounded" style ="background-color:rgba(114, 114, 114, 1);">
                ...
                <input type="number" name="science" class="form-control text-center fw-bold" value="{{old('lrn')}}{{Session::get('science')}}">
                @error('lrn')
                <p class="text-danger">
                  {{$message}}
                </p>
            ...
            <div class="col-md-7">
              <div class="row text-light">
                <div class="col-md-6"style ="background-color:rgba(114, 114, 114, 1); border-radius:20px;margin-left:10px;">
